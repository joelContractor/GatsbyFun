...
const StyledUserBannerImageGrid = styled(Grid, {
    ...
    ".bannerButton": { fontSize:"14px", textTransform: `none`, backgroundColor:`rgba(255, 255, 255, 0.8)`, width:`100%`, borderRadius: `50px`, color: `hsla(0, 0%, 0%, 0.7)`, fontWeight: `normal`, height: `50px`, padding: `4px 20px 4px 20px`, fontFamily: 'Georgia', position: `relative`, bottom: `22px`},
