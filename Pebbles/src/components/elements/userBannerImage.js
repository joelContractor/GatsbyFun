...
const StyledUserBannerImageGrid = styled(Grid, {
    ...
    ".diversityLogoArea": { position: `relative`, bottom: `-2px`, textAlign: `left`, marginTop:`0px`, background: `rgba(255, 255, 255, 0.7)`, borderRadius: `50px`, border: `1px solid #d3d3d3`, width:`fit-content`, marginLeft: `10px` },
