        ...
        <div style={{ margin: `0 auto`, maxWidth: 900, padding: `0 1.0875rem 1.45rem`, color:"#7e7e7e", fontSize:"0.8rem"}} >
          <Grid container direction="row" spacing={3}>
            ...
            <Grid item xs={6} style={{ textAlign:"right", paddingTop:"60px", fontSize:"0.8rem" }}>
              <h4 style={{ fontWeight:"normal", width:"90%", margin:"0 auto", paddingBottom:"3rem", fontSize:"1rem"}}>Participate</h4>
            ...
            <Grid item xs={6} style={{ textAlign:"left", paddingTop:"60px", fontSize:"0.8rem" }}>
              <h4 style={{ fontWeight:"normal", width:"90%", margin:"0 auto", paddingBottom:"3rem", fontSize:"1rem"}}>Be Aware</h4>
            ...
            <Grid item xs={4} style={{ textAlign:"center" }}>
              <h5 style={{ fontWeight:"normal" }}>Text Us</h5>
            ...
            <Grid item xs={4} style={{ textAlign:"center" }} >
              <h5 style={{ fontWeight:"normal" }}>Email Us</h5>
            ...
            <Grid item xs={4} style={{ textAlign:"center" }}>  
              <h5 style={{ fontWeight:"normal" }}>Call Us</h5>
