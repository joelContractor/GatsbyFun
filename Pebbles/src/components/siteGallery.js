...
const StyledGalleryGrid = styled(Grid, {
    ...
    ".cardMediaArea": {  height:"210px", marginBottom:"0px", borderTopLeftRadius: "20px", borderRadius: "20px", webkitBorderRadius: "20px", mozBorderRadius: "20px", khtmlBorderRadius: "20px" },
