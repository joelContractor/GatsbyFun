...
const StyledGalleryGrid = styled(Grid, {
    ...
    fontSize:`13px`,
    fontFamily:`Arial`,
    ".infoCard": { borderRadius:"20px", overFlow:"hidden", webkitMaskImage: "webkitRadialGradient(white, black)" },
    ...
    ".cardMediaArea": {  height:"210px", marginBottom:"0px", borderTopLeftRadius: "20px", borderTopRightRadius: "20px", webkitBorderRadius: "20px", mozBorderRadius: "20px", khtmlBorderRadius: "20px" },
