...
const StyledHistorySwiperGrid = styled(Grid, {
    ...
    ".swiper-button-prev": { color:"black", opacity:"0.3", position:"relative", bottom:"-25px", left:"-2px"},
    ".swiper-button-next": { color:"black", opacity:"0.3", position:"relative", bottom:"-2px", right:"-100px"},
