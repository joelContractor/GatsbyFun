...
const StyledHistorySwiperGrid = styled(Grid, {
    ...
    ".swiper-button-prev": { color:"black", opacity:"0.3", position:"relative", bottom:"-25px"},
    ".swiper-button-next": { color:"black", opacity:"0.3", position:"relative", bottom:"-2px", right:"-350px"},
