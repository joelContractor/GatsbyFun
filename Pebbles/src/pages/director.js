...
const DirectorPage = ({data}) => (
  <Layout>
    ...
    <Grid container sx={{marginBottom:'10px', padding:"20px 10px 0px 10px"}} spacing={3}>
      <Grid item xs={12}>
          <p style={{ marginBottom:"0rem", fontSize:"1.4rem" }}>Discover Diverse Directors</p>
      </Grid>
      <Grid item xs={12} md={12}>
        <p style={{ fontSize:"0.9rem", color: 'rgba(0, 0, 0, 0.6)' }}>
            Employing diverse directors can add a new dynamic to performances, while helping you gain funding for your project. We proactively collate diverse directors and agencies FREE. Swipe through our selection of featured directors.
        </p>
      </Grid>
